...
var BuiltinAgents = map[string]*AgentDefinition{
	AgentBuild: {
		...
		Tools: []string{"read", "write", "edit", "apply_patch", "grep", "glob", "shell", "webfetch", "websearch", "invoke_subagent", "question", "todowrite", "skill", "lsp", "ast_search", "revert_workspace", "plan_exit", "write_artifact", "user_diff", "workspace_diff", "invalid"},
		PermissionProfiles: map[string]string{
			"read":        "allowed",
			"write":       "allowed",
			"edit":        "allowed",
	...
	AgentPlan: {
		...
		Tools: []string{"read", "grep", "glob", "shell", "webfetch", "websearch", "invoke_subagent", "question", "todowrite", "skill", "lsp", "ast_search", "revert_workspace", "mcp", "write_artifact", "write", "edit", "apply_patch", "user_diff", "workspace_diff", "invalid"},
		PermissionProfiles: map[string]string{
			"read":        "allowed",
			"grep":        "allowed",
			"glob":        "allowed",
